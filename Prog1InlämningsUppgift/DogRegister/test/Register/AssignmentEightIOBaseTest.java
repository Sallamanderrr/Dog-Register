package Register;// JUnit-testfallen i denna fil testar Denna klass behövs för (nästan) alla test för föreläsning 8. Kommentarerna för hela klassen kan tas bort så fort ägarklassen är påbörjad, de ska INTE tas bort steg för steg
