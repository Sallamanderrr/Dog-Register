package Register;// JUnit-testfallen i denna fil testar Denna klass behövs för vissa test för föreläsning 8. Kommentarerna för hela klassen kan tas bort så fort ägarklassen är påbörjad, de ska INTE tas bort steg för steg
...
public abstract class AssignmentEightFunctionBaseTest extends FunctionBaseTest {
 	...
 	protected void assertOwnDog(Owner owner, Dog expectedDog) {
 		...
 		if (dogs == null)
 			fail(String.format("%s äger inte den förväntade hunden %s (arrayen är null)", owner.getName(),
 					expectedDog.getName()));
