package Register;// JUnit-testfallen i denna fil testar ägarklassens array av hundar
// För mer information se README.txt-filen
 ...
 public class AssignmentEightPointSixOwnerTest extends AssignmentEightFunctionBaseTest {
 	...
 	@Test
 	public void removingAnotherOwnersDogDoesNothingToArray() {
 		addDogToOwner(NIKE, BELLA);
 	...
 	@Test
 	public void removingAnotherOwnersDogDoesNothingToTheOtherOwnersArray() {
 		addDogToOwner(NIKE, BELLA);
 		addDogToOwner(JOZEF, SIGGE);
 		addDogToOwner(NIKE, MOLLY);
 		Dog[] expected = accessOwnDogs(JOZEF);
 		callMethodUnderTest(NIKE, SIGGE);
 		Dog[] actual = accessOwnDogs(JOZEF);
 		assertArrayEquals(expected, actual,
 				"Jozefs array av hundar har uppdaterats trots att ingen hund borde tagits bort");
 	}
 	...
 	// TODO: flera hundar i följd
 	// TODO: flera hundar, inte i följd
 }
 //COMMENT
